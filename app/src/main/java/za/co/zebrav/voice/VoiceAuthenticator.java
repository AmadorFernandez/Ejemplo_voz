...
public class VoiceAuthenticator
{
	...
	public void insertFeature(Codebook cb)
	{
		// Save password in list
		codeBook.add(cb);
	}

	public Codebook createCodebook(KMeans kmeans)
	{
	...
	public KMeans doClustering(FeatureVector pl)
	{
		long start;
	...
	{
		Log.i(LOG_TAG, "Starting to samples shorom buffer");
		double[] samples = readSamplesFromBuffer();
